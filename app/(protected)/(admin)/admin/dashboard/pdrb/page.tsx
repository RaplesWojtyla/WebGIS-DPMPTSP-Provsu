...
export default function PdrbAdminPage() {
    ...
    // We will stick to INITIAL_DB mostly for this session unless localStorage is implicitly needed for "persistence" during demo session (even if ephemeral).
    // The user said "ga usah pake local storage ya buat dummy aja".
    // So I will comment out the localStorage loading part or make it just use static state if possible, 
    // but the structure below is fine as it initializes from INITIAL_DB.
    /*
    useEffect(() => {
                                    ...
                                    <TableCell className="text-center">
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <Link href={`/admin/dashboard/pdrb/detail?regionId=${region.id}&year=${selectedYear}`} className="w-full">
